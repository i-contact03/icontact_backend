	...
	<div>
		<main class="join-main">
			...
			<div class="main-wrapper">
				<form action="joinOk.user" class="join-form">
...
=======
							<input type="text" id="userIdentification"  placeholder="아이디를 입력해 주세요." name="userIdentification" class="join-input" value=""> <!-- type="text" -->
						</div>
...
>>>>>>> origin/master
=======
							<input type="email" id="userEmail" placeholder="이메일을 입력해 주세요." name="userEmail" autocomplete="email" class="join-input" value="">
>>>>>>> icontact_backend:WebContent/templates/user/join.jsp
						</div>
...
=======
							<input type="password" id="userPassword" placeholder="비밀번호를 입력해 주세요. (8자리 이상)" name="userPassword" autocomplete="current-password" class="join-input" value="">
>>>>>>> icontact_backend:WebContent/templates/user/join.jsp
						</div>
...
>>>>>>> icontact_backend:WebContent/templates/user/join.jsp
					...
					<div class="content-wrapper" style="padding-bottom:8px;">
						<div class="input-wrapper">
							<input type="password" id="userPassword2" placeholder="비밀번호를 한번 더 입력해 주세요." name="passwordConfirm" autocomplete="current-password" class="join-input" value="">
						</div>
						
					<!-- 유효성 검사 -->
							<div class="css-red">
							<div class="">
								<p  class="password2" color="red500"></p>
							</div>
						</div>		
...
=======
							<input type="text" id="userName" placeholder="이름을 입력해 주세요." name="userName" autocomplete="off" class="join-input" value="">
						</div>
...
=======
							<input type="tel" id="userCall" placeholder="전화번호를 입력해 주세요." name="userCall" autocomplete="tel" class="join-input" value="">
						</div>
