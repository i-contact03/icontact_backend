...
<link rel="stylesheet" href="../../static/css/goods_register_1.css"/>
													...
													<div class="checkboxLayer" id="menu1" style="display: none;">
														<div class="checkBoxContainer">
															<ul class="selectList">
																...
																<li class="selectItem">IT·프로그래밍</li>
																<li class="selectItem">영상·사진·음향</li>
																<li class="selectItem">마케팅</li>
																<li class="selectItem">번역·통역</li>
																<li class="selectItem">문서·글쓰기</li>
																<li class="selectItem">창업·사업</li>
																<li class="selectItem">취업·입시</li>
																<li class="selectItem">전자책</li>
																<li class="selectItem">운세</li>
																<li class="selectItem">직무역량 레슨</li>
																<li class="selectItem">주문제작</li>
																<li class="selectItem">세무·법무·노무</li>
																<li class="selectItem">취미 레슨</li>
																<li class="selectItem">생활서비스</li>
																<li class="selectItem">심리상담</li>
																<li class="selectItem">VOD</li>
																<li class="selectItem">투잡·노하우</li>
																<li class="selectItem">자료·템플릿</li>
															</ul>
														</div>
													</div>
												</div>
											...
											<div class="bottom-wrapper-select">
												<div class="select">
													...
													<div id="menu2" class="checkboxLayer" style="display: none;">
														...
														<div class="checkBoxContainer">
															<ul class="selectList">
																<li class="selectItem">광고·홍보 영상</li>
																<li class="selectItem">제품 영상</li>
																<li class="selectItem">교육 영상</li>
																<li class="selectItem">행사 영상</li>
																<li class="selectItem">유튜브 영상</li>
																<li class="selectItem">온라인 중계</li>
																<li class="selectItem">드론 촬영</li>
																<li class="selectItem">컴퓨터 그래픽(CG)</li>
																<li class="selectItem">애니메이션</li>
																<li class="selectItem">영상 후반작업</li>
																<li class="selectItem">영상 기타</li>
																<li class="selectItem">제품·홍보 사진</li>
																<li class="selectItem">개인·이벤트 사진</li>
																<li class="selectItem">사진 보정</li>
																<li class="selectItem">성우</li>
																<li class="selectItem">음악·음원</li>
																<li class="selectItem">오디오 콘텐츠</li>
																<li class="selectItem">모델·배우</li>
																<li class="selectItem">기타 음향·음악</li>
															</ul>
														</div>
													</div>
												</div>
