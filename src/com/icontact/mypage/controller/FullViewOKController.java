...
import com.icontact.mypage.domain.Criteria2;
...
public class FullViewOKController implements Action {

	@Override
	public Result execute(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {

		System.out.println("mypage 컨트롤러 들어옴!");
...
//		============================
		...
		Criteria2 criteria = new Criteria2(page, ideaDAO.getTotalIdea());
