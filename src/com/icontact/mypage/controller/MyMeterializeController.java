...
public class MyMeterializeController implements Action {

	@Override
	public Result execute(HttpServletRequest req, HttpServletResponse resp) throws IOException, ServletException {
		
		System.out.println("mymeterialize 컨트롤러 들어옴!");
...
//		=------------====-================-----------------------
		...
		if(userDTO.getUserStatus().equals("1")) {
...
//		===========================
//		forward 방식
		result.setPath("templates/mypage/mymeterialize.jsp");
		return result;
//		return null;
	}
